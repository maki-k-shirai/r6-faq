    ...
    <div className="min-h-screen">
      <section className="border-b bg-gradient-to-b from-slate-50 to-white">
        <div className="mx-auto max-w-5xl px-4 py-8">
          <h1 className="text-2xl font-extrabold tracking-tight">社内方針ドキュメント</h1>
          <p className="mt-1 text-slate-600">
            PJの決定事項・運用方針・ガイドラインをまとめています。
          </p>
        </div>
      </section>
            ...
            {items.map((item) => (
              <li key={item.slug}>
                <Link
                  ...
                  className="flex items-center gap-4 px-6 py-4 hover:bg-amber-50 transition"
                >
